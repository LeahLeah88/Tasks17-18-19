...
- Added `MotionLayout` animation on `DetailFragment`.
- Tap on character card toggles transition between collapsed and expanded states.
- Implemented via:
  - `app/src/main/res/layout/fragment_detail.xml`
  - `app/src/main/res/xml/scene_detail.xml`
